...
from backend.amr.financial_p3_research_log_config import (
 collect_financial_p3_research_log_config,
 serialize_research_log_config,
)
from tests.fixtures.synthetic_financial_p3_research_log_config_cases import (
 make_inputs_for_log,
 make_snapshot,
)
...
def test_ready_task_gate_alias_is_accepted():
 ...
 assert collect_financial_p3_research_log_config(*values).entries[-1][0]=="config-task-gate"
